...
def get_fonts_directory() -> str:
    """Upload a font file to be used as a custom font for presentations."""
    app_data_dir = get_app_data_directory_env() or "/tmp/decklan"
    font_dir = os.path.join(app_data_dir, "fonts")
